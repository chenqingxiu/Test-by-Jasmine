...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
         ...
         */
        it('hidden in default', function(){
            // 隐藏实现方式：<body>的class包含'menu-hidden'
          ...
          * 再次点击的时候是否隐藏。
          */
        it('change by click', function(){
            // 点击图标的时候菜单显示,即移除<body>的class
            $('.menu-icon-link').trigger('click');
            expect($('body').hasClass('menu-hidden')).toBe(false);
            // 再次点击的时候隐藏,即<body>的class包含'menu-hidden'
            $('.menu-icon-link').trigger('click');
            expect($('body').hasClass('menu-hidden')).toBe(true);
         });
